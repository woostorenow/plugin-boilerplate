...
final class Plugin extends Singleton implements Loadable, Bootable, Initable {
	...
	public function freemius() {
		...
		if (!isset($vsfw_fs)) {
			$vsfw_fs = fs_dynamic_init([
				'id' => '5100',
				'slug' => 'variation-swatches-for-woocommerce-lite',
				'premium_slug' => 'variation-swatches-for-woocommerce-premium',
				'type' => 'plugin',
				'public_key' => 'pk_f1eb0a81c8236b47d80eb57705c31',
				'is_premium' => false,
				'has_addons' => false,
