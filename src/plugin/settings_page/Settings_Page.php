...
class Settings_Page implements Initable {
	...
	const PLUGIN_PAGE_SLUG = self::MENU_SLUG . '_extra';
	...
	protected function get_plugins_list() {
		$cached_plugins_list = get_transient('woostore_plugins_list');
		...
		set_transient('woostore_plugins_list', $response, DAY_IN_SECONDS * 7);
